...
import Server.system.ServerInit;
    ...
    public Collection<Flat> readCollection() {
        if (fileName != null && !fileName.isEmpty()) {
            try (var fileReader = new FileReader(fileName)) {
                var collectionType = new TypeToken<PriorityQueue<Flat>>() {
                }.getType();
            ...
            System.out.println("The command line argument with the file was not found!");
        }
