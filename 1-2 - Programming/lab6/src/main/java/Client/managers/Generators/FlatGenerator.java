package Client.managers.Generators;
...
public class FlatGenerator {
     ...
     * @return квартира
     */
    public static Flat generateFlat() {
        Flat flat = new Flat();
        ...
        if (scanner.nextLine().isEmpty()) {
            flat.setHouse(null);
        } else { House house = HouseGenerator.generateHouse();
            flat.setHouse(house); }
        System.out.println("Adding transport");
        if (scanner.nextLine().isEmpty()) {
            flat.setTransport(null);
        } else { Transport transport = TransportGenerator.generateTransport();
