...
public class CollectionManager {
    ...
    public PriorityQueue<Flat> getUsersElements(List<Long> ids) {
        return collection.stream().filter(p -> ids.contains(p.getId())).collect(Collectors.toCollection(PriorityQueue::new));
    }
